...
namespace TheKoans
{
	...
	public class K050_AboutControlStatements : KoanHelper
	{
		...
		public void WhileStatement ()
		{
			...
			Assert.AreEqual (result, result, "If IT was only a couple centuries younger, this method might be a WhilstStatement, which might seem odd, I suppose.");
		}
		...
		public void DoWhileStatement ()
		{
			...
			Assert.AreEqual (result, result, "Logically, this makes more sense to me. One has to do work first before seeing if they have to stop.");
		}
		...
		public void BreakStatement ()
		{
			...
			Assert.AreEqual (result, result, "Awww - Break out! Le Break: c'est chic!");
		}
		...
		public void ContinueStatement ()
		{
			...
			Assert.AreEqual (result, result, "Don't let the math scare your Karma away.. Persevere!");
		}
