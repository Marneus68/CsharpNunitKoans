...
namespace TheKoans
{
	...
	public class K030_AboutStrings : KoanHelper
	{
		...
		{
			var str = "Hello, World";
			Assert.AreEqual (typeof(System.String), str.GetType (), "What did Arial say to Serif? - Sorry, you're not my Type.");
		}
		...
		public void SingleQuotedStringsAreNotStrings ()
		{
			...
			var str = 'H';
			Assert.AreEqual (typeof(System.Char), str.GetType (), "A single tree does not a forest make.");
		}
