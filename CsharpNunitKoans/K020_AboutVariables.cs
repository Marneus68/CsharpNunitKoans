...
namespace TheKoans
{
	...
	public class K020_AboutVariables : KoanHelper
	{
		...
		public void MultipleAssignmentsOnSingleLine ()
		{
			...
			Assert.AreEqual (firstName, firstName, "Explicit type assignment should not impact the value.");
			Assert.AreEqual (lastName, lastName, "Implicit type assignment should also not impact the value (although lastName was explicitly set).");
		}
